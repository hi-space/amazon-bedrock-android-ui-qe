...
class BedrockClaude():
    ...
    '''    
    def invoke_llm(self, text: str, images: list = None, system: str = None):
        '''
        Args:
    ...
    def invoke_llm_response(self, text: str, images: list = None, system: str = None):
        return self.invoke_llm(
            text=text, images=images, system=system).get('content', [])[0].get('text', '')

    '''
    Bedrock Converse API
    '''
    def converse(self, text: str, images: list = None, system: str = None, format: str = 'png'):
        '''
        Args:
            text (str): Text content to send
            images (list): List of image bytes
            system (str): System prompt
            format (str): Image format (png, jpeg, gif, webp)
        Returns:
            str: 어시스턴트의 응답 텍스트
        '''
        # 메시지 내용 구성
    ...
    '''
    def converse_stream(self, text: str, images: list = None, system: str = None, format: str = 'png'):
        '''
        Args:
            text (str): Text content to send
            images (list): List of image bytes
